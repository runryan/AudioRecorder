...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of AudioRecorder.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/ryan/AudioRecorder'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'ryan' => 'mob_developer@163.com' }
  s.source           = { :git => 'https://github.com/ryan/AudioRecorder.git', :tag => s.version.to_s }
